#!/usr/bin/env python3
"""
Comprehensive WandB Data Extraction Script - Version 0815_v1

This script extracts ALL data from ALL projects in a WandB account.
No filters, no priorities - complete data extraction.
Modified to output to 0815_v1 folder instead of date-based naming.
"""
...
class ComprehensiveWandBExtractor:
    ...
    def __init__(self, entity: str = "t-jiachentu", output_base: str = None):
        ...
        # Use fixed folder name "0815_v1" instead of date
        self.date_str = "0815_v1"
    ...
    def save_project_data(self, project_name: str, data: Dict):
        ...
        project_info = {
            ...
            'extraction_version': data.get('extraction_version', '0815_v1'),
    ...
    def extract_all_projects(self):
        ...
        """
        print("\n" + "="*60)
        print("Starting comprehensive WandB data extraction - Version 0815_v1")
    ...
    def print_summary(self):
        ...
        print("\n" + "="*60)
        print("EXTRACTION COMPLETE - Version 0815_v1")
        print("="*60)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Extract ALL data from ALL WandB projects - Version 0815_v1"
    )
    parser.add_argument(
        '--entity', 
        type=str, 
